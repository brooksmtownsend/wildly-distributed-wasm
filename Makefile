...
HOST ?= DEFINEME
CONSTELLATION ?= DEFINEMETOO
start-kv:
	wash ctl start actor ghcr.io/brooksmtownsend/dist-kv:0.2.0 --skip-wait --host-id $(HOST) --lattice-prefix $(CONSTELLATION)
	-wash ctl start provider wasmcloud.azurecr.io/kvredis:0.17.0 --skip-wait --host-id $(HOST) --lattice-prefix $(CONSTELLATION)
	-wash ctl start provider wasmcloud.azurecr.io/nats_messaging:0.14.5 --skip-wait --host-id $(HOST) --lattice-prefix $(CONSTELLATION)
	wash ctl link put MC4KXRTFQJHGGH3WX3OCDZZEHAIGSUDZOG533JHJTVN44H3KPBUO4NRW VADNMSIML2XGO2X4TPIONTIC55R2UUQGPPDZPAVSC2QD7E76CR77SPW7 wasmcloud:messaging 'SUBSCRIPTION=wasmkv.>'
	wash ctl link put MC4KXRTFQJHGGH3WX3OCDZZEHAIGSUDZOG533JHJTVN44H3KPBUO4NRW VAZVC4RX54J2NVCMCW7BPCAHGGG5XZXDBXFUMDUXGESTMQEJLC3YVZWB wasmcloud:keyvalue